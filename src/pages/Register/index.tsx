...
export default function Register() {
  ...
  const registerAccountMutation = useMutation({
    mutationFn: (body: TAuthSchema) => registerAccount(body)
  })
  ...
  return (
    <div className="flex flex-col justify-center items-center pt-14">
      <div className="w-[428px]">
        <div className="mb-10">
          <div className="text-4xl text-center mb-6">{t('register')}</div>
        ...
        <form className="p-10 rounded-md shadow" onSubmit={onSubmit} noValidate>
          ...
          />
          <div>
            <button className="w-full bg-primary text-white text-center py-3 px-2 rounded-sm">{t('register')}</button>
          </div>
        </form>
      </div>
    </div>
